...
public class MailTemplateInstanceCompletionStageToUni extends Recipe {
    ...
    protected TreeVisitor<?, ExecutionContext> getVisitor() {
        return new MailTemplateInstanceCompletionStageToUniVisitor();
    }

    private static class MailTemplateInstanceCompletionStageToUniVisitor extends JavaIsoVisitor<ExecutionContext> {
